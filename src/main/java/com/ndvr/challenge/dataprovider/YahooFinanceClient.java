...
public class YahooFinanceClient {
    ...
    private String constructURL(String ticker, LocalDate from, LocalDate to) {
        ...
        return String.format(PRICE_FORMAT_URL, encodedTicker, fromEpoch, toEpoch, crumb);
    }
    ...
    private HttpEntity fetchURL(String url, String symbol, LocalDate fromDate, LocalDate toDate) {
        ...
        if (statusCode == HttpStatus.UNAUTHORIZED) {
            ...
            request.setURI(URI.create(constructURL(symbol, fromDate, toDate))); // Acquire new crumb
            request.reset();
    ...
    public List<Pricing> fetchPriceData(String symbol, LocalDate fromDate, LocalDate toDate) {
        ...
        String priceURL = constructURL(symbol, fromDate, toDate);
